...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        //anyOf 안에 포함된 조건이 하나라도 맞으면 pass
        //allOf 모두 맞아야 pass
        ...
        assertThat(sampleString2, allOf(startsWith("Player"), endsWith("point"), containsString("p")));
    }
    ...
    public void shouldHaveSamePropertyAndValue() {
        ...
        List<String> chamArray = championNames1;

        assertThat(championNames1, samePropertyValuesAs(championNames2));
        assertThat(championNames1, samePropertyValuesAs(chamArray));
    }
